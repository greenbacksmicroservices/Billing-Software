...
urlpatterns = [
    ...
    path('company/invoices/<int:pk>/edit/', views.InvoiceUpdateView.as_view(), name='invoice_edit'),
    ...
    path('company/purchase-orders/', views.PurchaseOrderListView.as_view(), name='purchase_order_list'),
    path('company/purchase-orders/add/', views.PurchaseOrderCreateView.as_view(), name='purchase_order_add'),
    path('company/purchase-orders/<int:pk>/', views.PurchaseOrderDetailView.as_view(), name='purchase_order_view'),
    path('company/purchase-orders/<int:pk>/edit/', views.PurchaseOrderUpdateView.as_view(), name='purchase_order_edit'),
    path('company/purchase-orders/<int:pk>/pdf/', views.PurchaseOrderPDFView.as_view(), name='purchase_order_pdf'),
    path('company/purchase-orders/<int:pk>/status/<str:status>/', views.purchase_order_status_change, name='purchase_order_status'),
    path('company/purchase-orders/<int:pk>/duplicate/', views.purchase_order_duplicate, name='purchase_order_duplicate'),
    path('company/purchase-orders/<int:pk>/send-email/', views.purchase_order_send_email, name='purchase_order_send_email'),
    path('company/purchase-orders/<int:pk>/convert-to-bill/', views.purchase_order_convert_to_bill, name='purchase_order_convert_bill'),
    path('company/purchase-orders/<int:pk>/delete/', views.purchase_order_delete, name='purchase_order_delete'),
    ...
    path('company/purchase-bills/<int:pk>/documents/upload/', views.purchase_bill_upload_document, name='purchase_bill_upload_document'),
    path('company/purchase-bills/documents/<int:doc_id>/delete/', views.purchase_bill_delete_document, name='purchase_bill_delete_document'),
    path('company/purchase-bills/documents/<int:doc_id>/view/', views.purchase_bill_view_document, name='purchase_bill_view_document'),
    path('api/company/warehouses/<int:pk>/detail/', views.warehouse_detail_api, name='warehouse_detail_api'),
